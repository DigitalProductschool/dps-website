        ...
        <div className="whats-new__content u-content">
          ...
          <div className="whats-new__content__tiles">
            <div className="item-1">
              <a href="https://leaks.digitalproductschool.io/design-thinking-a-creative-way-to-foster-innovation-ab9ef97cd884" className="whats-new__content__tile">
            ...
            <div className="item-2">
              <a href="https://leaks.digitalproductschool.io/digital-product-school-dps-86f48a7d4d69" className="whats-new__content__tile">
                <div className="whats-new__content__tile__thumb">
            ...
            <div className="item-3">
              <a href="https://www.youtube.com/watch?v=pVikgqTpulg" className="whats-new__content__tile">
