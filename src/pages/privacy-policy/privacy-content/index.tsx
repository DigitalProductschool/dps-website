...
class PrivacyContent extends React.Component {
  render() {
    return (
      <section className="privacy u-content-wrapper">
        <div className="privacy__content u-content">
          <h1>PRIVACY POLICY OF UNTERNEHMERTUM GMBH</h1>
          ...
          <p>
            Alexander Stolberg-Stolberg<br />
            SVDFJ Rechtsanwälte<br />
            Oberanger 30<br />
            80331 München<br />
            Deutschland<br />
            +49 89 210 25 120<br />
            <a href="mailto:stolberg@unternehmertum.de" className="u-link"><span>stolberg@unternehmertum.de</span></a><br />
            <a href="https://svdfj.de" className="u-link"><span>www.svdfj.de</span></a>
          </p>
          ...
          <p>Through the use of cookies, the UnternehmerTUM GmbH can provide the users of this website with more user-friendly services that would not be possible without the cookie setting.</p>
          ...
          <p>On the website of the UnternehmerTUM GmbH, users are given the opportunity to subscribe to our enterprise's newsletter. The input mask used for this purpose determines what personal data are transmitted, as well as when the newsletter is ordered from the controller.</p>

          <p>The UnternehmerTUM GmbH informs its customers and business partners regularly by means of a newsletter about enterprise offers. The enterprise's newsletter may only be received by the data subject if</p>

          <p>
          (1) the data subject has a valid e-mail address and<br />
          ...
          <p>
          The newsletter of the UnternehmerTUM GmbH contains so-called tracking pixels. A tracking pixel is a miniature graphic embedded in such e-mails, which are sent in HTML format to enable log file recording and analysis. This allows a statistical analysis of the success or failure of online marketing campaigns. Based on the embedded tracking pixel, the UnternehmerTUM GmbH may see if and when an e-mail was opened by a data subject, and which links in the e-mail were called up by data subjects.
          </p>
          <p>
          Such personal data collected in the tracking pixels contained in the newsletters are stored and analyzed by the controller in order to optimize the shipping of the newsletter, as well as to adapt the content of future newsletters even better to the interests of the data subject. These personal data will not be passed on to third parties. Data subjects are at any time entitled to revoke the respective separate declaration of consent issued by means of the double-opt-in procedure. After a revocation, these personal data will be deleted by the controller. The UnternehmerTUM GmbH automatically regards a withdrawal from the receipt of the newsletter as a revocation.
          </p>
          ...
          <p>a) Right of confirmation. Each data subject shall have the right granted by the European legislator to obtain from the controller the confirmation as to whether or not personal data concerning him or her are being processed. If a data subject wishes to avail himself of this right of confirmation, he or she may, at any time, contact our Data Protection Officer or another employee of the controller.</p>

          <p>b) Right of access. Each data subject shall have the right granted by the European legislator to obtain from the controller free information about his or her personal data stored at any time and a copy of this information. Furthermore, the European directives and regulations grant the data subject access to the following information:</p>
          ...
          <p>c) Right to rectification. Each data subject shall have the right granted by the European legislator to obtain from the controller without undue delay the rectification of inaccurate personal data concerning him or her. Taking into account the purposes of the processing, the data subject shall have the right to have incomplete personal data completed, including by means of providing a supplementary statement.?If a data subject wishes to exercise this right to rectification, he or she may, at any time, contact our Data Protection Officer or another employee of the controller.</p>

          <p>d) Right to erasure (Right to be forgotten). Each data subject shall have the right granted by the European legislator to obtain from the controller the erasure of personal data concerning him or her without undue delay, and the controller shall have the obligation to erase personal data without undue delay where one of the following grounds applies, as long as the processing is not necessary:</p>
          ...
          <p>If one of the aforementioned reasons applies, and a data subject wishes to request the erasure of personal data stored by the UnternehmerTUM GmbH, he or she may at any time contact our Data Protection Officer or another employee of the controller. The Data Protection Officer of the UnternehmerTUM GmbH or another employee shall promptly ensure that the erasure request is complied with immediately.?Where the controller has made personal data public and is obliged pursuant to Article 17(1) to erase the personal data, the controller, taking account of available technology and the cost of implementation, shall take reasonable steps, including technical measures, to inform other controllers processing the personal data that the data subject has requested erasure by such controllers of any links to, or copy or replication of, those personal data, as far as processing is not required. The Data Protection Officer of the UnternehmerTUM GmbH or another employee will arrange the necessary measures in individual cases.</p>

          <p>e) Right of restriction of processing. Each data subject shall have the right granted by the European legislator to obtain from the controller restriction of processing where one of the following applies:</p>
              
          ...
               
          <p>If one of the aforementioned conditions is met, and a data subject wishes to request the restriction of the processing of personal data stored by the UnternehmerTUM GmbH, he or she may at any time contact our Data Protection Officer or another employee of the controller. The Data Protection Officer of the UnternehmerTUM GmbH or another employee will arrange the restriction of the processing.</p>
               
          <p>f) Right to data portability. Each data subject shall have the right granted by the European legislator, to receive the personal data concerning him or her, which was provided to a controller, in a structured, commonly used and machine-readable format. He or she shall have the right to transmit those data to another controller without hindrance from the controller to which the personal data have been provided, as long as the processing is based on consent pursuant to point (a) of Article 6(1) of the GDPR or point (a) of Article 9(2) of the GDPR, or on a contract pursuant to point (b) of Article 6(1) of the GDPR, and the processing is carried out by automated means, as long as the processing is not necessary for the performance of a task carried out in the public interest or in the exercise of official authority vested in the controller.?Furthermore, in exercising his or her right to data portability pursuant to Article 20(1) of the GDPR, the data subject shall have the right to have personal data transmitted directly from one controller to another, where technically feasible and when doing so does not adversely affect the rights and freedoms of others.?In order to assert the right to data portability, the data subject may at any time contact the Data Protection Officer designated by the UnternehmerTUM GmbH or another employee.</p>
               
          <p>g) Right to object. Each data subject shall have the right granted by the European legislator to object, on grounds relating to his or her particular situation, at any time, to processing of personal data concerning him or her, which is based on point (e) or (f) of Article 6(1) of the GDPR. This also applies to profiling based on these provisions. The UnternehmerTUM GmbH shall no longer process the personal data in the event of the objection, unless we can demonstrate compelling legitimate grounds for the processing which override the interests, rights and freedoms of the data subject, or for the establishment, exercise or defence of legal claims. If the UnternehmerTUM GmbH processes personal data for direct marketing purposes, the data subject shall have the right to object at any time to processing of personal data concerning him or her for such marketing. This applies to profiling to the extent that it is related to such direct marketing. If the data subject objects to the UnternehmerTUM GmbH to the processing for direct marketing purposes, the UnternehmerTUM GmbH will no longer process the personal data for these purposes. In addition, the data subject has the right, on grounds relating to his or her particular situation, to object to processing of personal data concerning him or her by the UnternehmerTUM GmbH for scientific or historical research purposes, or for statistical purposes pursuant to Article 89(1) of the GDPR, unless the processing is necessary for the performance of a task carried out for reasons of public interest. In order to exercise the right to object, the data subject may directly contact the Data Protection Officer of the UnternehmerTUM GmbH or another employee. In addition, the data subject is free in the context of the use of information society services, and notwithstanding Directive 2002/58/EC, to use his or her right to object by automated means using technical specifications.</p>
               
          <p>h) Automated individual decision-making, including profiling. Each data subject shall have the right granted by the European legislator not to be subject to a decision based solely on automated processing, including profiling, which produces legal effects concerning him or her, or similarly significantly affects him or her, as long as the decision (1) is not is necessary for entering into, or the performance of, a contract between the data subject and a data controller, or (2) is not authorised by Union or Member State law to which the controller is subject and which also lays down suitable measures to safeguard the data subject's rights and freedoms and legitimate interests, or (3) is not based on the data subject's explicit consent. If the decision (1) is necessary for entering into, or the performance of, a contract between the data subject and a data controller, or (2) it is based on the data subject's explicit consent, the UnternehmerTUM GmbH shall implement suitable measures to safeguard the data subject's rights and freedoms and legitimate interests, at least the right to obtain human intervention on the part of the controller, to express his or her point of view and contest the decision. If the data subject wishes to exercise the rights concerning automated individual decision-making, he or she may at any time directly contact our Data Protection Officer of the unternehmerTUM GmbH or another employee of the controller.</p>
               
          <p>i) Right to withdraw data protection consent. Each data subject shall have the right granted by the European legislator to withdraw his or her consent to processing of his or her personal data at any time. If the data subject wishes to exercise the right to withdraw the consent, he or she may at any time directly contact our Data Protection Officer of the UnternehmerTUM GmbH or another employee of the controller.</p>
          ...
          The data protection guideline published by Facebook, which is available at <a href="https://facebook.com/about/privacy/" className="u-link"><span>https://facebook.com/about/privacy/</span></a>, provides information about the collection, processing and use of personal data by Facebook. In addition, it is explained there what setting options Facebook offers to protect the privacy of the data subject. In addition, different configuration options are made available to allow the elimination of data transmission to Facebook. These applications may be used by the data subject to eliminate a data transmission to Facebook.</p>


          <h3>11. DATA PROTECTION PROVISIONS GOOGLE ANALYTICS (WITH ANONYMIZATION FUNCTION)</h3>

          <p>On this website, the controller has integrated the component of Google Analytics (with the anonymizer function). Google Analytics is a web analytics service. Web analytics is the collection, gathering, and analysis of data about the behavior of visitors to websites. A web analysis service collects, inter alia, data about the website from which a person has come (the so-called referrer), which sub-pages were visited, or how often and for what duration a sub-page was viewed. Web analytics are mainly used for the optimization of a website and in order to carry out a cost-benefit analysis of Internet advertising.</p>

          <p>The operator of the Google Analytics component is Google Ireland Limited, Gordon House, Barrow Street, Dublin 4, Irland.
          ...
          <p>Further information and the applicable data protection provisions of Google may be retrieved under <a href="https://www.google.com/intl/en/policies/privacy/" className="u-link"><span>https://www.google.com/intl/en/policies/privacy/</span></a> and under <a href="http://www.google.com/analytics/terms/us.html" className="u-link"><span>http://www.google.com/analytics/terms/us.html</span></a>. Google Analytics is further explained under the following Link <a href="https://www.google.com/analytics/" className="u-link"><span>https://www.google.com/analytics/</span></a>.</p>
          ...
          LinkedIn provides under <a href="https://www.linkedin.com/psettings/guest-controls" className="u-link"><span>https://www.linkedin.com/psettings/guest-controls</span></a> the possibility to unsubscribe from e-mail messages, SMS messages and targeted ads, as well as the ability to manage ad settings. LinkedIn also uses affiliates such as Eire, Google Analytics, BlueKai, DoubleClick, Nielsen, Comscore, Eloqua, and Lotame. The setting of such cookies may be denied under <a href="https://www.linkedin.com/legal/cookie-policy" className="u-link"><span>https://www.linkedin.com/legal/cookie-policy</span></a>. The applicable privacy policy for LinkedIn is available under <a href="https://www.linkedin.com/legal/privacy-policy" className="u-link"><span>https://www.linkedin.com/legal/privacy-policy</span></a>. The LinkedIn Cookie Policy is available under <a href="https://www.linkedin.com/legal/cookie-policy" className="u-link"><span>https://www.linkedin.com/legal/cookie-policy</span></a>.</p>
          ...
          The applicable data protection provisions of Twitter may be accessed under <a href="https://twitter.com/privacy?lang=en" className="u-link"><span>https://twitter.com/privacy?lang=en</span></a>.</p>
          ...
          <h3>15. THE LEGITIMATE INTERESTS PURSUED BY THE CONTROLLER OR BY A THIRD PARTY</h3>
          ...
          <h3>17. PROVISION OF PERSONAL DATA AS STATUTORY OR CONTRACTUAL REQUIREMENT; REQUIREMENT NECESSARY TO ENTER INTO A CONTRACT; OBLIGATION OF THE DATA SUBJECT TO PROVIDE THE PERSONAL DATA; POSSIBLE CONSEQUENCES OF FAILURE TO PROVIDE SUCH DATA</h3>
          ...
          <p>To integrate different databases and tools, we use Zapier, a service of Zapier Inc., 548 Market St # 62411, San Francisco, California 94104, USA. In this case, customer data can be transmitted with the exception of the payment data. More information about Zapier's privacy can be found at <a href="https://zapier.com/privacy/" className="u-link"><span>https://zapier.com/privacy/</span></a></p>


          <h3>20.  CRAZY EGG</h3>

          <p>We use on our website the web tracking tool Crazy Egg. This service is provided by Crazy Egg, Inc., 6220 E. Ridgeview Lane , La Mirada, CA , 90638, USA. Crazy Egg uses "Cookies", text files that are stored on your computer to track how users move across this website. The information generated through your usage of the website usually is sent to a server in the USA where it also is stored. You can prevent the storage of cookies through the according setting in your web browser. You can also prevent the storage, processing and the usage of the data generated through your visit (including your IP address) by following the instructions through this link:
          <a href="http://www.crazyegg.com/opt-out" className="u-link"><span>http://www.crazyegg.com/opt-out</span></a></p>

          <p>Detailed information about the collecting, processing and usage of the data by Crazy Egg you can find here in Crazy Egg's privacy policy:</p>

          <a href="http://www.crazyegg.com/privacy" className="u-link"><span>http://www.crazyegg.com/privacy</span></a>


          <h3>21.  TRELLO</h3>

          <p>We use the web-based project management tool Trello to process the applicants' data. We do this to store the applicants' data so our staff can evaluate and handle applications.  This service is provided by  Trello, Inc., 55 Broadway, 25th Floor, New York, NY 10006, USA.</p>

          <p>Detailed information about the collecting, processing and usage of the data by Trello you can find here:</p>

          <a href="https://trello.com/privacy" className="u-link"><span>https://trello.com/privacy</span></a> abgerufen werden.


          <h3>22.  TYPEFORM</h3>

          <p>For the retrieval of our applications we use a tool of the spanish company Typeform (<a href="https://www.typeform.com" className="u-link"><span>www.typeform.com</span></a>).
          We gather the following data:</p>

          <p>Name<br/>
          Email address</p>

          <p>This service is provided by  Typeform S.L., Carrer Doctor Trueta, 113-119, Planta 1, 08005 Barcelona.</p>

          <p>Detailed information about the collecting, processing and usage of the data by Typeform you can find here:
          <a href="https://admin.typeform.com/to/dwk6gt" className="u-link"><span>https://admin.typeform.com/to/dwk6gt</span></a></p>
        </div>
      </section>
    );
  }
