...
I advise and coach our teams with exploring the AI applications, their feasibility, and risks for problem-solution fits. In a multi-disciplinary setup, I support them with challenges on how a data-driven solution should be developed and evaluated and how to transform the assumptions and data requirements to product vision and market opportunities.`,
  ...
  },
  {
    ...
    description: `I previously founded startup projects and worked as a Business Developing Analyst at Rocket Internet GmbH. Later I pursued my Masters in Integrated Design from the Anhalt University of  Applied Sciences in Germany. I am also an alumna from Digital Product School batch five 2018. Where as a Product Manager together with my team I built an application to assist parents travelling with their children. 
...
`,
  ...
  },
  {
    ...
    description: `After getting my masters degree in computer science at ELTE in Budapest I worked as a researcher at the university. Later I moved to Germany and worked for different companies in the machine learning and data analytics areas shifting more and more focus also to people management.
...
`,
  ...
  },
  {
    ...
    description: `After my dual vocational training as a specialist in media and information services at the publishing house Sueddeutscher Verlag in Munich I became Junior Project Manager at the communication agency SZ Scala. During the last 2,5 years, I acquired project management and marketing skills and how to optimize processes efficiently in particular.
...
`,
  ...
  },
  {
    ...
    description: `I studied Management and Technology at Technische Universität München and hustled in Startups among different industries.
...
`,
  ...
  },
  {
    ...
    description: `I am in the final semester of my masters studies in Computer Science at TUM. Before joining DPS, I worked as a frontend web developer at TUM and HomeFox Gmbh where I gained some skills in ReactJS and VueJS. Then later I was a SE participant in batch #5 at DPS where my team developed a chrome plugin for personalized Google search using VueJS.
...
`,
  ...
  },
  {
    ...
    description: `I am an experienced scrum master. I have a background in business administration from HTWG Constance. Earlier in my career I realised that agile and scrum methods play a crucial role in product development. This is when I decided to pursue this and become a scrum master. 
