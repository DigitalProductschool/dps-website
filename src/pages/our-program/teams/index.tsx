    ...
    return (
      <section className="teams u-section-margin-top u-content-wrapper">
        <div className="teams__content u-content">
          <img alt="teams" className="teams__title__image u-image" src="/assets/program/teams/title.jpg" />
          ...
          <div className="teams__content__companies">
            ...
            <div className="teams__content__companies__desc">
              <img alt="company-teams" className="teams__content__companies__image u-image" src="/assets/program/teams/companies.jpg" />
              <p className="u-text">
          ...
          <div className="teams__content__wild">
            ...
            <div className="u-grid-4-6">
              ...
              <img alt="wild-teams" className="teams__content__wild__image u-image" src="/assets/program/teams/wild.jpg" />
            </div>
          </div>
        </div>
      </section>
