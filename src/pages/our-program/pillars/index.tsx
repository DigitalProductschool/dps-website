      ...
      <section className="pillars u-section-margin-top u-content-wrapper">
        <div className="pillars__content u-content">
          ...
          <ul className="pillars__list">
            ...
            <li className="pillars__list__item">
              <div className="pillars__list__item__icon-wrapper"><img alt="network-logo" className="pillars__list__item__icon-wrapper__img pillars__list__item__icon-wrapper__img" src="/assets/program/pillars/network.svg" /></div>
            ...
            <li className="pillars__list__item">
              <div className="pillars__list__item__icon-wrapper"><img alt="agile-logo" className="pillars__list__item__icon-wrapper__img pillars__list__item__icon-wrapper__img" src="/assets/program/pillars/agile.png" /></div>
            ...
            <li className="pillars__list__item">
              <div className="pillars__list__item__icon-wrapper"><img alt="scholar-logo" className="pillars__list__item__icon-wrapper__img pillars__list__item__icon-wrapper__img" src="/assets/program/pillars/scholar.svg" /></div>
            ...
            <li className="pillars__list__item">
              <div className="pillars__list__item__icon-wrapper"><img alt="campus-logo" className="pillars__list__item__icon-wrapper__img pillars__list__item__icon-wrapper__img" src="/assets/program/pillars/campus.png" /></div>
