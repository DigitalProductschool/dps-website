  ...
  renderDescription() {
    if (this.props.isApplyNowVersion) {
      return <p className="pick-track__description">
          ...
          <b># Batch #10: May 4 to July 24, 2020</b> (Application phase starts in October 2019)  <br />
          <b># Batch #11: Sept. 8 to Nov. 27, 2020</b> (Application phase starts in February 2020)
        </p>;
    } else {
      return <p className="pick-track__description">
