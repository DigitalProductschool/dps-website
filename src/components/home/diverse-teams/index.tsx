      ...
      <div className="diverse-teams u-content-wrapper">
        ...
        <div className="diverse-teams__content u-content">
          <p className="diverse-teams__content__description">
            ...
            crossfunctional teams. At the Digital Product School, interaction
            designers,{' '}
            <Link to="/apply/software-engineering" className="u-link">
              <span> software engineers </span>
            </Link>{' '}
            data scientists and product managers from all over the world are
            working together across disciplines to create great products in a
            lean and agile way.
          </p>
