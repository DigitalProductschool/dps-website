        ...
        <div className="remote-collaboration u-content">
          <div className="remote-collaboration__content">
            ...
            <p className="remote-collaboration__description">
              Some months ago we were convinced that real teamwork and
              innovative digital product development only can happen if people
              from different backgrounds and a big pile of post-its come
