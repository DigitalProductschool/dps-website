      ...
      <div className="face-it u-content-wrapper">
        <div className="face-it__content u-content">
          ...
          <p className="u-text">
            ...
            methods, techniques, frameworks, tools, buzzwords, communication
            strategies.  But to reap the benefit and to see it all falling into
            place, you need to work on projects with different challenges. And
            alongside some great teammates.
          </p>
        </div>
      </div>
    );
