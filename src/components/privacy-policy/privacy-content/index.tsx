      ...
      <section className="privacy u-content-wrapper">
        <div className="privacy__content u-content">
          ...
          <p>
            ...
            management of the UnternehmerTUM GmbH. The use of the Internet pages
            of the UnternehmerTUM GmbH is possible without any indication of
          ...
          <p>
            ...
            applicable to the UnternehmerTUM GmbH. By means of this data
            ...
            rights to which they are entitled. As the controller, the
            UnternehmerTUM GmbH has implemented numerous technical and
            ...
            alternative means, e.g. by telephone.<br />
          </p>
          <h3>1. DEFINITIONS</h3>
          <p>
            The data protection declaration of the UnternehmerTUM GmbH is based
            ...
            declaration should be legible and understandable. To ensure this, we
          ...
          <p>
            ...
            <br />
            +49 89 18 94 69 0<br />
            <a href="mailto:info@unternehmertum.de" className="u-link">
          ...
          <p>
            ...
            +49 89 210 25 120
            <br />
            <a href="mailto:stolberg@unternehmertum.de" className="u-link">
              <span>stolberg@unternehmertum.de</span>
            </a>
            <br />
            <a href="https://svdfj.de" className="u-link">
              <span>www.svdfj.de</span>
            </a>
          </p>
          <p>
          ...
          <p>
            The Internet pages of the UnternehmerTUM GmbH use cookies. Cookies
            are text files that are stored in a computer system via an Internet
            browser. Many Internet sites and servers use cookies. Many cookies
          ...
          <p>
            Through the use of cookies, the UnternehmerTUM GmbH can provide the
            users of this website with more user-friendly services that would
          ...
          <p>
            ...
            customer has placed in the virtual shopping cart via a cookie. The
            data subject may, at any time, prevent the setting of cookies
            ...
            functions of our website may be entirely usable.<br />
          </p>
          <h3>5. COLLECTION OF GENERAL DATA AND INFORMATION</h3>
          <p>
            The website of the UnternehmerTUM GmbH collects a series of general
          ...
          <p>
            When using these general data and information, the UnternehmerTUM
            ...
            prosecution in case of a cyber-attack. Therefore, the UnternehmerTUM
          ...
          <p>
            On the website of the UnternehmerTUM GmbH, users are given the
          ...
          <p>
            A confirmation e-mail will be sent to the e-mail address registered
            by a data subject for the first time for newsletter shipping, for
            legal reasons, in the double opt-in procedure. This confirmation
            e-mail is used to prove whether the owner of the e-mail address as
            the data subject is authorized to receive the newsletter. During the
            registration for the newsletter, we also store the IP address of the
            computer system assigned by the Internet service provider (ISP) and
            used by the data subject at the time of the registration, as well as
            the date and time of the registration. The collection of this data
          ...
          <p>
            The newsletter of the UnternehmerTUM GmbH contains so-called
            ...
            embedded tracking pixel, the UnternehmerTUM GmbH may see if and when
            an e-mail was opened by a data subject, and which links in the
          ...
          <p>
            ...
            erased in accordance with legal requirements.<br />
          </p>
          ...
          <p>
            b) Right of access. Each data subject shall have the right granted
          ...
          <p>
            c) Right to rectification. Each data subject shall have the right
            ...
            right to rectification, he or she may, at any time, contact our Data
            Protection Officer or another employee of the controller.
          </p>
          <p>
            d) Right to erasure (Right to be forgotten). Each data subject shall
          ...
          <p>
            ...
            UnternehmerTUM GmbH, he or she may at any time contact our Data
            Protection Officer or another employee of the controller. The Data
            Protection Officer of the UnternehmerTUM GmbH or another employee
            shall promptly ensure that the erasure request is complied with
            immediately.?Where the controller has made personal data public and
            ...
            as processing is not required. The Data Protection Officer of the
            UnternehmerTUM GmbH or another employee will arrange the necessary
            measures in individual cases.
          </p>
          <p>
            e) Right of restriction of processing. Each data subject shall have
          ...
          <p>
            ...
            stored by the UnternehmerTUM GmbH, he or she may at any time contact
            our Data Protection Officer or another employee of the controller.
          ...
          <p>
            ...
            her particular situation, at any time, to processing of personal
            ...
            these provisions. The UnternehmerTUM GmbH shall no longer process
            ...
            for the establishment, exercise or defence of legal claims. If the
            UnternehmerTUM GmbH processes personal data for direct marketing
            ...
            UnternehmerTUM GmbH to the processing for direct marketing purposes,
            the UnternehmerTUM GmbH will no longer process the personal data for
            ...
            UnternehmerTUM GmbH for scientific or historical research purposes,
            ...
            carried out for reasons of public interest. In order to exercise the
            right to object, the data subject may directly contact the Data
            Protection Officer of the UnternehmerTUM GmbH or another employee.
          ...
          <p>
            ...
            subject's explicit consent. If the decision (1) is necessary for
            entering into, or the performance of, a contract between the data
            subject and a data controller, or (2) it is based on the data
            subject's explicit consent, the UnternehmerTUM GmbH shall implement
            suitable measures to safeguard the data subject's rights and
            ...
            her point of view and contest the decision. If the data subject
            wishes to exercise the rights concerning automated individual
            decision-making, he or she may at any time directly contact our Data
          ...
          <p>
            ...
            network through friend requests. The operating company of Facebook
            is Facebook, Inc., 1 Hacker Way, Menlo Park, CA 94025, United
            States. If a person lives outside of the United States or Canada,
            the controller is the Facebook Ireland Ltd., 4 Grand Canal Square,
          ...
          <p>
            ...
            <a
              ...
              className="u-link"
            >
              <span>https://developers.facebook.com/docs/plugins/</span>
            </a>
          ...
          <p>
            ...
            data transmission to Facebook.<br />
          </p>
          <h3>
            11. Facebook Pixel
          </h3> 
          <p>
          Our website measures conversions using visitor action pixels from Facebook,
          Facebook Inc., 1601 S. California Ave, Palo Alto, CA 94304, USA (“Facebook”)
          </p>
          <p>
          These allow the behavior of site visitors to be tracked after they click on 
          a Facebook ad to reach the provider’s website. This allows an analysis of the 
          effectiveness of Facebook advertisements for statistical and market research 
          purposes and their future optimization.
          </p>
          <p>
          The data collected is anonymous to us as operators of this website and we cannot 
          use it to draw any conclusions about our users’ identities. However, the data 
          are stored and processed by Facebook, which may make a connection to your Facebook 
          profile and which may use the data for its own advertising purposes, as stipulated 
          in the Facebook privacy policy. This will allow Facebook to display ads both on 
          Facebook and on third-party sites. We have no control over how this data is used.
          </p>
          <p>
          Check out Facebook’s privacy policy to learn more about protecting your privacy:
          <a href="https://facebook.com/about/privacy/" className="u-link">
          <span>https://facebook.com/about/privacy/</span><br />
          You can also deactivate the custom audiences remarketing feature in the Ads Settings 
          section at 
          <a href="https://www.facebook.com/ads/preferences/?entry_product=ad_settings_screen/" className="u-link">
          <span>https://www.facebook.com/ads/preferences/?entry_product=ad_settings_screen/</span>.<br />
          You will first need to log into Facebook. If you do not have a Facebook account, 
          you can opt out of usage-based advertising from Facebook on the website of the 
          European Interactive Digital Advertising Alliance: 
          <a href="http://www.youronlinechoices.com/de/praferenzmanagement/" className="u-link">
          <span>http://www.youronlinechoices.com/de/praferenzmanagement/</span>.<br />
          </p>   
          <h3>
          ...
          <p>
            ...
            Limited, Gordon House, Barrow Street, Dublin 4, Irland. For the web
            analytics through Google Analytics the controller uses the
            application "_gat. _anonymizeIp". By means of this application the
            IP address of the Internet connection of the data subject is
          ...
          <p>
            ...
            <a
              ...
              className="u-link"
            >
              <span>https://www.google.com/intl/en/policies/privacy/</span>
            </a>{' '}
            and under{' '}
            <a
              ...
              className="u-link"
            >
              <span>http://www.google.com/analytics/terms/us.html</span>
            </a>
          ...
          <p>
            ...
            <a
              ...
              className="u-link"
            >
              <span>https://www.linkedin.com/psettings/guest-controls</span>
            </a>{' '}
            the possibility to unsubscribe from e-mail messages, SMS messages
            and targeted ads, as well as the ability to manage ad settings.
            LinkedIn also uses affiliates such as Eire, Google Analytics,
            BlueKai, DoubleClick, Nielsen, Comscore, Eloqua, and Lotame. The
          ...
          <p>
            ...
            so-called ‘tweets,’ e.g. short messages, which are limited to 140
          ...
          <p>
            ...
            <a
              ...
              className="u-link"
            >
              <span>https://about.twitter.com/de/resources/buttons</span>
            </a>
            . During the course of this technical procedure, Twitter gains
            knowledge of what specific sub-page of our website was visited by
            the data subject. The purpose of the integration of the Twitter
            component is a retransmission of the contents of this website to
            allow our users to introduce this web page to the digital world and
          ...
          <p>
            ...
            our website is made. The applicable data protection provisions of
          ...
          <p>
            ...
            of the well-being of all our employees and the shareholders.<br />
          </p>
          ...
          <p>
            ...
            the initiation of a contract.<br />
          </p>
          <h3>
          ...
          <p>
            ...
            CA , 90638, USA. Crazy Egg uses "Cookies", text files that are
            stored on your computer to track how users move across this website.
            The information generated through your usage of the website usually
            is sent to a server in the USA where it also is stored. You can
            prevent the storage of cookies through the according setting in your
            web browser. You can also prevent the storage, processing and the
            usage of the data generated through your visit (including your IP
            address) by following the instructions through this link:
            <a href="http://www.crazyegg.com/opt-out" className="u-link">
              <span>http://www.crazyegg.com/opt-out</span>
            </a>
          </p>
          <p>
            Detailed information about the collecting, processing and usage of
            the data by Crazy Egg you can find here in Crazy Egg's privacy
            policy:
          </p>
